...
const ProductForm = (props) => {
    ...
    const date_diff = (receiptDate, expirationDate) => {
        let dt1 = new Date(receiptDate);
        let dt2 = new Date(expirationDate);
    ...
    return (
        <Form onSubmit={onSubmit}>
            ...
            <FormGroup>
                ...
                <Input
                    invalid={!isExpirationDateValid(date_diff(receiptDate, expirationDate))}
                    type="date"
                    name="expirationDate"
                    id="expirationDate"
